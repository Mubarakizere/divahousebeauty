...
<div class="max-w-4xl">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 ml-11">Update banner details and settings</p>
    </div>
    ...
    <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="mb-4">
                ...
                <div class="relative inline-block rounded-lg overflow-hidden border border-gray-200">
                    <img src="{{ $banner->image_url }}" alt="{{ $banner->name }}" 
                         class="max-w-full h-auto max-h-48 object-cover">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="image" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p class="text-sm text-gray-500"><span class="font-semibold">Click to upload</span> new image</p>
                ...
                @enderror
                <p class="mt-2 text-xs text-gray-500">Leave empty to keep current image. Max 30MB</p>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="target" id="target"
                            ...
                            <option value="_self" {{ old('target', $banner->target) == '_self' ? 'selected' : '' }}>Same Tab</option>
                            <option value="_blank" {{ old('target', $banner->target) == '_blank' ? 'selected' : '' }}>New Tab</option>
                        </select>
                    </div>
                </div>
            </div>
...
@push('scripts')
<script>
// Image preview for replacement image
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            ...
            previewContainer.innerHTML = `
                ...
                <div class="relative inline-block rounded-lg overflow-hidden border border-gray-200">
                    <img src="${e.target.result}" alt="New Preview" class="max-w-full h-auto max-h-48 object-cover">
                </div>
            `;
        };
